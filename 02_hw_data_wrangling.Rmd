...
The type of candidate with the highest average was Democrats.
...
The histogram shows a right skew, with more candidates having less than 10 million ads impressions.
...
filter(office == "US House") |>
  ...
  mutate(cand_name_last_reorder = fct_reorder(cand_name_last, impressions_millions)) |>
  ggplot(mapping = aes(
    x = impressions_millions,
    y = cand_name_last_reorder)) +
  geom_bar(aes(
    fill = party), stat = "identity") +
  labs(
